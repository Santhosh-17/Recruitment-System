...
public class RegisterFrame  extends JFrame {
	...
	JButton b1,b2;
	Rconnect rc;
	String name,uname,mail,pn,address,pwd,pwd2;
	
	RegisterFrame()
	{
		super("User Registeration");
		
	}
	
	public void initrf(Signup s)
	{
		l1 = new JLabel();
        l2 = new JLabel();
        l3 = new JLabel();
        ...
        b1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
            	...
            	if (pwd.equals(pwd2))
            	{
            		try {  rc.rconnect(uname,name,mail,pn,address,pwd); } catch (Exception e) {	}
            		setVisible(false);
            		s.setVisible(true);
            	}
            	else
        ...
        l9.setIcon(new javax.swing.ImageIcon("E:\\Eclipse\\workspace\\MiniProject2\\src\\mp2\\bgg2.jpg")); 
        add(l9);
